...
CONF_INTERVAL_CPU = CONF_INTERVAL + SENSORS_TYPE_CPU
CONF_INTERVAL_DEVICES = CONF_INTERVAL + SENSORS_TYPE_DEVICES
CONF_INTERVAL_LIGHT = CONF_INTERVAL + SENSORS_TYPE_LIGHT
CONF_INTERVAL_MISC = CONF_INTERVAL + SENSORS_TYPE_MISC
CONF_INTERVAL_NETWORK_STAT = CONF_INTERVAL + SENSORS_TYPE_NETWORK_STAT
CONF_INTERVAL_PORTS = CONF_INTERVAL + SENSORS_TYPE_PORTS
CONF_INTERVAL_RAM = CONF_INTERVAL + SENSORS_TYPE_RAM
CONF_INTERVAL_SYSINFO = CONF_INTERVAL + SENSORS_TYPE_SYSINFO
CONF_INTERVAL_TEMPERATURE = CONF_INTERVAL + SENSORS_TYPE_TEMPERATURE
CONF_INTERVAL_VPN = CONF_INTERVAL + SENSORS_TYPE_VPN
CONF_INTERVAL_WAN = CONF_INTERVAL + SENSORS_TYPE_WAN
CONF_INTERVAL_WLAN = CONF_INTERVAL + SENSORS_TYPE_WLAN
